...
import {WeightedMathLib as Reference} from "test/WeightedMathLib/Reference.sol";
...
contract GetInvariantTest is Test {
    ...
    function testGetInvariantCorrectness() public {
        ...
        uint256 customMultitoken =
            Custom.getInvariant(reserveIn, reserveOut, weightIn, weightOut);
        uint256 referenceMultitoken =
            Reference._calculateInvariant(weights, reserves);
